...
myApp.controller("myController", function ($scope, $http, ENV) {
  ...
  $scope.meetingId = "";
  $scope.isCreatedMeetingClicked = false;
  $scope.isJoinMeetingClicked = false;
  $scope.showMeetingIdError = false;
  $scope.showParticipantNameError = false;
  ...
  $scope.handleNameValidation = function () {
  ...
  $scope.createMeeting = function () {
    $scope.isCreatedMeetingClicked = true;
  ...
  $scope.joinMeeting = function () {
    $scope.isJoinMeetingClicked = true;
  };

  $scope.initMeeting = function () {
    const isNameValid = $scope.handleNameValidation();
    ...
    if (isNameValid) {
      ...
      $scope.showParticipantNameError = true;
    }
  };
